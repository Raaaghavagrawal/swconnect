...
export default function DoctorLogin() {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      // Enforce Doctor-only login on this page
      ...
      show('Welcome back, Doctor!', { type: 'success' });
      navigate('/doctor');
    } catch (err) {
      ...
      <div className="absolute top-4 right-4">
        <div className="relative">
          ...
          >
            ...
            <button
              onClick={() => { setMenuOpen(false); navigate('/rmp-login'); }}
      ...
      <div className="w-full max-w-6xl">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="hidden lg:block">
            <div className="relative overflow-hidden rounded-3xl p-10 text-white bg-gradient-to-r from-[var(--color-primary)] to-emerald-600 shadow-xl">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-emerald-50 text-lg">Doctor Portal</p>
          ...
          <div className="glass-card p-6 md:p-8">
            <div className="mb-6">
              <h2 className="text-2xl font-semibold text-[var(--color-text)]">Doctor Login</h2>
              <p className="text-slate-600 mt-1">Sign in to your doctor account</p>
              <div className="mt-1 text-xs text-slate-500">For patients and RMPs, use the "Other logins" menu at the top-right.</div>
            </div>
            <form onSubmit={onSubmit} className="space-y-5">
              ...
              <div className="text-sm text-center">
                New here? <Link to="/signup" state={{ role: 'Doctor' }} className="text-[var(--color-secondary)] hover:underline">Create a doctor account</Link>
              </div>
            </form>
          </div>
        </div>
