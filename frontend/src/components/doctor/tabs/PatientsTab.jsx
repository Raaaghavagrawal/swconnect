...
import PatientCard from '../../rmp/PatientCard';

export default function PatientsTab({ patients, onViewPatient, onSync }) {
          ...
          >
            {filteredPatients.map((patient, idx) => (
              ...
              >
                <PatientCard
                  patient={patient}
                  onVisitClick={onViewPatient}
                  onViewReport={onViewPatient}
                />
              </motion.div>
            ))}
          </motion.div>
