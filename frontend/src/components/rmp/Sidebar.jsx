...
import { LayoutDashboard, Users, FileText, Pill, MessageSquare, Calendar, BarChart3, Settings } from 'lucide-react';
...
const menuItems = [
  ...
  { id: 'pharmaconnect', label: 'PharmaConnect', icon: Pill },
  ...
  const sidebarContent = (
    ...
    >
      <div className="h-full flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto" role="navigation" aria-label="RMP sections">
